...
CREATE TABLE `controller_type` (
  `controllertype_id` int NOT NULL AUTO_INCREMENT,
  `controllertype_name` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `datetime` datetime DEFAULT NULL,
  PRIMARY KEY (`controllertype_id`)
