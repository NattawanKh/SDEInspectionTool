...
CREATE TABLE `device_profile` (
  `deprofile_id` int NOT NULL AUTO_INCREMENT,
  `name_prefix` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `devicetype_id` int NOT NULL,
  `controllertype_id` int NOT NULL,
  `emplacement_id` int NOT NULL,
  `floor_name` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`deprofile_id`)
...
-- Dump completed on 2024-11-15 11:12:13
